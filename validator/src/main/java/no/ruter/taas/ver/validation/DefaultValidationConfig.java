...
class DefaultValidationConfig {
  ...
  static String EQUIPMENT_LIST_SCHEMA = "equipment_list.schema.json";
  static String INVENTORY_SCHEMA = "inventory.schema.json";
  static String INVENTORY_LIST_SCHEMA = "inventory_list.schema.json";
  ...
  static String EQUIPMENT_LIST_SCHEMA_LOCATION = SCHEMA_PATH + EQUIPMENT_LIST_SCHEMA;
  static String INVENTORY_SCHEMA_LOCATION = SCHEMA_PATH + INVENTORY_SCHEMA;
  static String INVENTORY_LIST_SCHEMA_LOCATION = SCHEMA_PATH + INVENTORY_LIST_SCHEMA;
